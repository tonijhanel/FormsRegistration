...
************************************************************************ */
import {
  propertyChange, ExecuteRule, Initialize, CustomEvent, Submit, RemoveInstance, AddInstance, Reset, RemoveItem, AddItem, Click, Change, FormLoad, FieldChanged, ValidationComplete, Valid, Invalid,
} from './afb-events.js';
...
const isRepeatable = (obj) => ((obj.repeatable
...
const __decorate$3 = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
const __decorate$2 = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
  const c = arguments.length; let r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc; let
    d;
  if (typeof Reflect === 'object' && typeof Reflect.decorate === 'function') r = Reflect.decorate(decorators, target, key, desc);
  else for (let i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
class Container extends Scriptable {
  ...
  getState() {
    return {
      ...super.getState(),
      items: this._children.map((x) => ({ ...x.getState() })),
    };
  }
...
const submit = async (context, success, error, submitAs = 'application/json', input_data = null) => {
  ...
  const submitDataAndMetaData = { data, submitMetadata: { lang: context.form.lang } };
...
const __decorate$1 = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
  const c = arguments.length; let r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc; let
    d;
  if (typeof Reflect === 'object' && typeof Reflect.decorate === 'function') r = Reflect.decorate(decorators, target, key, desc);
  else for (let i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
const __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
  const c = arguments.length; let r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc; let
    d;
  if (typeof Reflect === 'object' && typeof Reflect.decorate === 'function') r = Reflect.decorate(decorators, target, key, desc);
  else for (let i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
class Field extends Scriptable {
  ...
  get displayValue() {
    ...
    if (this.isNotEmpty(this.value) && this.valid !== false) {
      ...
      if (this.fieldType === 'number-input') {
...
export {
  createFormInstance, fetchForm, registerFunctions, validateFormData, validateFormInstance,
};
