...
function getTimezoneOffsetFrom(otherTimezone) {
  ...
  const otherOffset = (other.day * 24 * 60) + (other.hour * 60) + (other.minute); // utc date + otherTimezoneDifference
  const myLocaleOffset = (myLocale.day * 24 * 60) + (myLocale.hour * 60) + (myLocale.minute); // utc date + myTimeZoneDifference
...
export {
  formatDate, formatNumber, getSkeleton, parseDate, parseNumber,
};
